...
async function Product({
  ...
  const { product } = await params;  // Destructure directly
  ...
  if (!selectedProduct) {
    // If no product is found, you can display an error or fallback
